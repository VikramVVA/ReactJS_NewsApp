...
<body>
<div className="md:h-screen bg-white relative flex flex-col justify-center items-center mt-3">
    <div className="md:border md:border-gray-300 bg-white md:shadow-lg shadow-none rounded p-10" >
        ...
        <form className="my-8">
            <div className="relative mb-2">
                <input id="email" className="w-full rounded px-3 border border-gray-300 pt-5 pb-2 focus:border-blue-700 focus:ring-1 focus:ring-blue-700 focus:outline-none input active:outline-none" placeholder="Email or phone" type="text" autofocus />
            </div>
